			  ...
			  sql:{	
				...
				try {
					...
					while (resultSet.next()) {
						...
						int basedaysTypeId = resultSet.getInt("base_days_type_id");
						int wagesTypeId = resultSet.getInt("wages_type_id");
						int sundayId = resultSet.getInt("sunday_sel_id");
						
						unitMasterBeanList.add(new UnitMasterBean(unitId, companyId, unitName, company_Name, baseDaysType, wagesType, sundaySelection, working_hour, basedaysTypeId, wagesTypeId, sundayId));
					}  
				} finally{
