...
public class RunPayRollService {
    ...
    public static void saveEmpSalStore(ArrayList<RunPayRollBean> runPayRollBeanList, RunPayRollBean bean, int coId, int unitId,int unitDesId,String salMonth,String year, int sheetTypeId){
    	RunPayRollDao.saveSalSheet(runPayRollBeanList, bean, coId, unitId, unitDesId, salMonth, year, sheetTypeId );
    ...
    public static ArrayList<RunPayRollBean> loadEmpSalStore(PayrollExistBean pxBean, int exSheetTypeId){
    	ArrayList<RunPayRollBean> list = new ArrayList<RunPayRollBean>(); 
    	list = PayRollExistDao.loadEmpSalDetails2(pxBean, exSheetTypeId);
    	return list;
    }
