...
public class RunPayRollSql {
	...
	public static final String loadMonthQuery = " SELECT month_id, month FROM pms_month_master order by month_id ";
	...
	public static final String loadExSheetTypeQuery = " SELECT salary_sheet_type_id,sheet_type FROM pms_salary_sheet_type where sheet_type <> 'GENERAL SHEET' and is_delete='N' ";
	...
	public static final String loadEmpDetailsQuery2 = " select employee_id, employee_code, employee_name, "
													  ...
													  + " and unit_designation_id = ? and is_delete = 'N' order by employee_code ";
	...
	public static final String empInsertSalStore = " INSERT INTO pms_emp_sal_store( " +
										            ...
										            " created_by, updatetd_by, emp_name, extra_time, extra_amt, sheet_type_id, sheet_type) " +
										            " VALUES (?, ?, ?, ?, " + 
										            " ?, ?, ?, ?, " + 
										            " ?, ?, ?, ?, ?, ?, " + 
										            " ?, ?, ?, ?, ?, " + 
	...
	public static final String empInsertSalDetailsStore = "INSERT INTO pms_emp_sal_store_comp_details( "
						            				...
						            				+" emp_id, emp_code, month, year, amount, company_id, unit_id, unit_designation_id, sheet_type_id, sheet_type, pms_emp_sal_store_id) "
						            				+" VALUES ( ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?);";
	...
	public static final String empSalStoreSelectQuery = "SELECT employee_id , " +
														...
														" total_deduction, ed, " +
														" company_name, unit_name, designation, extra_time, extra_amt " +
														...
														" AND leave_yr             = ? " +
														" AND sheet_type_id = ? " +
														" AND is_delete = 'N' order by employee_code ";
	...
	public static final String empSalStoreCompoDetlQuery = "select component_id, component_type_id, component_name,emp_id, " +
														   ...
														   " and month = ? and year = ? and sheet_type_id = ? and is_delete = 'N' ";
	
	public static final String wagesTypeSelQry = "select wages_type_id from pms_unit_master where unit_id = ? and company_id = ? ";
	
	public static final String countQry = "select count(pms_emp_sal_store_id) as count from pms_emp_sal_store where company_id = ? and unit_id = ? and unit_desiganatoin_id = ? and salary_month = ? and leave_yr = ? and sheet_type_id = ? and is_delete = 'N' ";
