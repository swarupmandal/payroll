...
public class UnitMasterViewModel {
	...
	@Command
	@NotifyChange("*")
	public void onClickDelete(@BindingParam("bean") final UnitMasterBean unitmasterbean){
	...
	public void onClickEdit(@BindingParam("bean")UnitMasterBean bean){
		...
		//System.out.println(" FI >>> >> > " + bean.getUnitId() +" - " + bean.getBaseDaysType() + " - " + bean.getWagesType() + " - " + bean.getWorkingHour() + " - " + bean.getSundaySelection());
