...
public class RunPayRollBean {
    ...
    private boolean exChecked = false;
    ...
    private ArrayList<EmployeeSalaryComponentAmountBean> exComponentAmountBeanList = new ArrayList<EmployeeSalaryComponentAmountBean>();
    private ArrayList<EmployeeSalaryComponentAmountBean> exEarningCompList = new ArrayList<EmployeeSalaryComponentAmountBean>();
    private ArrayList<EmployeeSalaryComponentAmountBean> exDeductionCompList = new ArrayList<EmployeeSalaryComponentAmountBean>();
	...
	public int getSheetTypeId() {
		return sheetTypeId;
	}

	public void setSheetTypeId(int sheetTypeId) {
		this.sheetTypeId = sheetTypeId;
	}

	public ArrayList<EmployeeSalaryComponentAmountBean> getExComponentAmountBeanList() {
		return exComponentAmountBeanList;
	}

	public void setExComponentAmountBeanList(
			ArrayList<EmployeeSalaryComponentAmountBean> exComponentAmountBeanList) {
		this.exComponentAmountBeanList = exComponentAmountBeanList;
	}

	public ArrayList<EmployeeSalaryComponentAmountBean> getExEarningCompList() {
		return exEarningCompList;
	}

	public void setExEarningCompList(
			ArrayList<EmployeeSalaryComponentAmountBean> exEarningCompList) {
		this.exEarningCompList = exEarningCompList;
	}

	public ArrayList<EmployeeSalaryComponentAmountBean> getExDeductionCompList() {
		return exDeductionCompList;
	}

	public void setExDeductionCompList(
			ArrayList<EmployeeSalaryComponentAmountBean> exDeductionCompList) {
		this.exDeductionCompList = exDeductionCompList;
	}

	public boolean isExChecked() {
		return exChecked;
	}

	public void setExChecked(boolean exChecked) {
		this.exChecked = exChecked;
	}
